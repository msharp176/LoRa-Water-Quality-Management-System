...
// Index = Wiper Position
typedef struct sdia_potentiometer_full_calibration_s {
    sdia_potentiometer_cal_data_t DCPos_calibration[0xff];
    sdia_potentiometer_cal_data_t DCNeg_calibration[0xff];
    sdia_potentiometer_cal_data_t GainUpper_calibration[0xff];
    sdia_potentiometer_cal_data_t GainLower_calibration[0xff];
    sdia_potentiometer_cal_data_t RefUpper_calibration[0xff];
    sdia_potentiometer_cal_data_t RefLower_calibration[0xff];
 ...
 */
bool sdia_convert_wiper_setting(sdia_context_t *context, sdia_wiper_settings_t *setting_in, sdia_analog_setting_t *analog_equivalent);
 ...
 * @param wiper_setting: The wiper setting to apply to the software-defined instrumentation amplifier before reading back the voltage
